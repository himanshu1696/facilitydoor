jQuery(function($) {'use strict',
    ...
    $("#login-btn").click(function(){
    	...
    	var field1 = document.getElementById('user-name').value;
    	var field2 = document.getElementById('password').value;

    	//console.log(field1+" "+field2);
    	
    	$.post("http://facilitydoor.com/api/loginapp.php",
    ...
    $("#signup-btn").click(function(){
        ...
        /*console.log(name+" "+emailid+" "+password+" "+phone);

*/
        $.post("http://facilitydoor.com/api/regapp.php",
